...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Check if no branch is selected and set Branch to an empty array if so
      const Branch = selectedBranch ? [selectedBranch] : [];
      const Center = memberData.CenterIDMember
  ...
  const handleBranchChange = (e) => {
    ...
    setBranch(branch); // Update Branch with selected branch
  ...
  const handleCenterChange = (e) => {
    ...
    setCenter(selectedCenterID); // Update Center with selected center ID
