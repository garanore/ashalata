...
const ReviewLoan = () => {
  ...
  const CheckedLoans = async (id) => {
    try {
      const updatedLoans = { approvalStatus: "Approved" }; // or 'Approved' depending on your logic
      ...
      setReviewLoans((prevState) =>
        prevState.map((Loan) =>
          Loan._id === id ? { ...Loan, approvalStatus: "Approved" } : Loan
        )
      );
      ...
      <div className="p-3">
        ...
        {currentLoans.length > 0 ? (
          ...
          <div className="alert alert-warning text-center" role="alert">
            ...
            পুনঃনিরীক্ষণের জন্য কোন ঋণ নেই।
          </div>
        )}
      </div>
