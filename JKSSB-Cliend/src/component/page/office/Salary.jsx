...
const Salary = () => {
  ...
  const [monthError, setMonthError] = useState(""); // New state for month error
  ...
  const handleMonthChange = (event) => {
    ...
    setMonthError(""); // Clear the error message when the month is selected
  };
  ...
  const handleSubmit = async () => {
    ...
    const data = workers.map((worker) => ({
      ...
      totalPF: calculateTotalPF(worker.workerID) || 0,
      totalSalAndAllowances:
        calculateTotalSalAndAllowances(worker.workerID) || 0,
